...
| 编号 | 建议 | 优先级 | 成本 | 风险 | 关联 |
|---|---|---|---|---|---|
| R-01 | CI 增加单测门禁 | **P0** | S | 无 | 补 F-01 长效机制 |
| R-02 | 清理遗留反射 com.apps.LauncherActivity | P0 | S | 低 | N-01 |
| R-03 | 契约文档补注（无消费方键 / 冻结接口声明） | P0 | S | 无 | N-02 |
| R-04 | 构建弃用 API 清理 | P0 | S | 低 | 工程观察 |
| R-05 | GameScreen.kt 三步拆分 | **P1** | M | 中 | 06 §5.2 |
| R-06 | EngineScanner 职责分离 | P1 | M | 中 | 06 §5.3 |
| R-07 | EngineLauncher 纯函数补测 | P1 | S | 无 | 06 §5.4 |
| R-08 | TyranoLocalHttpServer 回环集成测试 | P1 | M | 无 | F-13 延伸 |
| R-09 | SDL2 官方源对照重整 | **P2 专项** | L | 高 | F-11 收尾 |
| R-10 | 测试矩阵延伸（存档 zip 往返 / Asar 边界 / detectEngine 全分支） | P2 | M | 无 | F-01 延伸 |
| R-11 | Gradle 10 兼容预演 | P2 | S | 低 | 工程观察 |
| R-12 | APK 体积决策框架（F-05） | P3 决策 | — | — | F-05 |
| R-13 | 多语言最小可行范围（F-06） | P3 决策 | — | — | F-06 |
| R-14 | 渠道合规材料清单（F-08） | P3 决策 | — | — | F-08 |
